    ...
    def _SendPacket(self, pkt, port):
        ...
        for attempt in range(self.retries):
            ...
            while now<waitto:
                ...
                try:
                    # There seems to be a problem in the VerifyReply method whereby
                    # the calculated md5 hash isn't matching the returned packet correctly
                    #reply=pkt.CreateReply(packet=rawreply)
                    return pkt.CreateReply(packet=rawreply)
